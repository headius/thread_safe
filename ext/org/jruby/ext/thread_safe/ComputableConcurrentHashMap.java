...
/**
 * Verbatim copy of the JCP JSR-166's <tt>ConcurrentHashMap</tt> Revision 1.118
 * with the <tt>ConcurrentHashMapV8</tt>'s added computeIfAbsent method.
 *
 * Code changes:
 * * added <tt>MappingFunction</tt> interface
 * * added <tt>ComputableConcurrentHashMap.computeIfAbsent</tt>
 * * added <tt>ComputableConcurrentHashMap.Segment.computeIfAbsent</tt>
 * * using JRuby's UnsafeGetter
 *
 * TODO: switch to ConcurrentHashMapV8 proper.
 */
 ...
 */
public class ComputableConcurrentHashMap<K, V> extends AbstractMap<K, V>
//        implements ConcurrentHashMapWithComputable<K, V>, ConcurrentMap<K, V>, Serializable {
    ...
    static final class Segment<K,V> extends ReentrantLock implements Serializable {
        ...
        final V computeIfAbsent(K key, int hash, MappingFunction<? super K, ? extends V> mappingFunction) {
            if (!tryLock())
            ...
            try {
                ...
                for (HashEntry<K,V> e = first;;) {
                    if (e != null) {
                        ...
                        if ((value = mappingFunction.map(key)) == null) {
     ...
     */
    @SuppressWarnings("unchecked")
    public ComputableConcurrentHashMap(int initialCapacity,
     ...
     * @since 1.6
     */
    public ComputableConcurrentHashMap(int initialCapacity, float loadFactor) {
     ...
     */
    public ComputableConcurrentHashMap() {
     ...
     * @param m the map
     */
    public ComputableConcurrentHashMap(Map<? extends K, ? extends V> m) {
    ...
    public V computeIfAbsent(K key, MappingFunction<? super K, ? extends V> mappingFunction) {
        ...
        if ((s = (Segment<K,V>)UNSAFE.getObjectVolatile(segments, (j << SSHIFT) + SBASE)) != null &&
                (tab = s.table) != null) {
            for (HashEntry<K,V> e = (HashEntry<K,V>) UNSAFE.getObjectVolatile
                    (tab, ((long)(((tab.length - 1) & h)) << TSHIFT) + TBASE);
                 e != null; e = e.next) {
        ...
        return s.computeIfAbsent(key, h, mappingFunction);
    }
    ...
    abstract class HashIterator {
        ...
        public final void remove() {
            ...
            ComputableConcurrentHashMap.this.remove(lastReturned.key);
            lastReturned = null;
        }
    }
            ...
            extends AbstractMap.SimpleEntry<K,V>
    {
        ...
        public V setValue(V value) {
            ...
            ComputableConcurrentHashMap.this.put(getKey(), value);
            return v;
        }
    }
    ...
    final class KeySet extends AbstractSet<K> {
        ...
        public int size() {
            return ComputableConcurrentHashMap.this.size();
        }
        public boolean isEmpty() {
            return ComputableConcurrentHashMap.this.isEmpty();
        }
        public boolean contains(Object o) {
            return ComputableConcurrentHashMap.this.containsKey(o);
        }
        public boolean remove(Object o) {
            return ComputableConcurrentHashMap.this.remove(o) != null;
        }
        public void clear() {
            ComputableConcurrentHashMap.this.clear();
        }
    }
    ...
    final class Values extends AbstractCollection<V> {
        ...
        public boolean contains(Object o) {
            return ComputableConcurrentHashMap.this.containsValue(o);
        }
        public void clear() {
            ComputableConcurrentHashMap.this.clear();
        }
    ...
    final class EntrySet extends AbstractSet<Map.Entry<K,V>> {
        ...
        public boolean contains(Object o) {
            ...
            V v = ComputableConcurrentHashMap.this.get(e.getKey());
        ...
        public boolean remove(Object o) {
            if (!(o instanceof Map.Entry))
                return false;
            Map.Entry<?,?> e = (Map.Entry<?,?>)o;
            return ComputableConcurrentHashMap.this.remove(e.getKey(), e.getValue());
        }
        public int size() {
            return ComputableConcurrentHashMap.this.size();
        }
